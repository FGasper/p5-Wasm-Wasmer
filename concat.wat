(module
 ...
 (export "concat" (func $export:concat/concat))
 (start $~start)
 ...
 (func $concat/concat (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
 ...
 (func $export:concat/concat (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
